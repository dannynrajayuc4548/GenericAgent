...
# Increased default max_turns from 40 to 60 -- I kept hitting the limit on longer tasks
def agent_runner_loop(client, system_prompt, user_input, handler, tools_schema, max_turns=60, verbose=True, initial_user_content=None):
    ...
    while turn < handler.max_turns:
        ...
        # Reset tool descriptions every 8 turns instead of 10 for better context freshness
